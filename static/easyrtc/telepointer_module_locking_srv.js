...
$("#design_pipelines_menu_biodatacleaning_id").click(function () {
        ...
        //Sync request (done for simulation... set to async otherwise) to the server
        //for getting the new module id to keep it unique among all the clients.
        $.ajax({
            type: "POST",
            cache: false,
            ...
            error: function (xhr, status, error) {
                alert("Some Error Occured while getting New Module ID from Server!");
            },
            async: false
